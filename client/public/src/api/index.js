...
export const updateWorkout = (id, updatedWorkout) => axios.patch(`${workoutUrl}/${id}`, updatedWorkout);
...
export const updateDay = (id, updatedDay) => axios.patch(`${dayUrl}/${id}`, updatedDay);
...
export const updateSet = (id, updatedSet) => axios.patch(`${setUrl}/${id}`, updatedSet);
...
export const updateRep = (id, updatedRep) => axios.patch(`${repUrl}/${id}`, updatedRep);
